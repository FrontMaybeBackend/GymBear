            ...
            <div class="card h-100"  style=" width: 250px;
             height: 300px;" >
                ...
                <div class="card-footer">
                    <a id="readMore" class="btn btn-link link-dark p-md-1 my-1" data-mdb-toggle="collapse" href="../crud/read/readSupp.php?id=<?php echo $supplementss->idPRO; ?>" role="button" aria-expanded="false" aria-controls="collapseContent">Read more</a>
                </div>
            </div>
        </section>
    <?php endforeach; ?>
